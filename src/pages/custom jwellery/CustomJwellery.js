...
function CustomJwellery() {
  return (
    <div>
      <Header />
      <div className="container">
        <h1 className="cont-head">Custom Jewellery</h1>
		...
		<div className="back-home">
			<div className="navbar-contact">
                <a href="/" className="contact-button">Back to Home</a>
            </div>
		</div>
      </div>
    </div>
